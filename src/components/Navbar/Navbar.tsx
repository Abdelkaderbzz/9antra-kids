import menuIcon from '@src/assets/icons/navbar/menu.svg'
import { useLocation, useNavigate } from 'react-router-dom'
import { Avatar, Dropdown, MenuProps, Space } from 'antd'
import { ReactComponent as ProfileIcon } from '@src/assets/icons/sidebar/profile.svg'
...
const Navbar: React.FC<INavbarProps> = ({
  ...
  const accountInfoItems: MenuProps['items'] = [
    ...
    //   key: '3',
    //   label: (
    //     <div className='dropdown-navigation-btn' onClick={() => navigate('/settings')}>
    //       <SettingsIcon style={{ stroke: 'black', width: '18px', height: '18px' }} />
    //       <span>Settings</span>
    //     </div>
    //   ),
    // },
